...
{
    public partial class xfrmTemperaturaPellet_2 : DevExpress.XtraEditors.XtraForm
    {
        public xfrmTemperaturaPellet_2()
        {
            InitializeComponent();
            load_orden_activas();
        }
        ...
        {
            string query = @"dbo.sp_get_turnos_registro_temperaturas_Pellet_2";
        ...
        private void gridView1_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            string query = @"dbo.sp_get_temperatura_pellet_2_log_v2";
            DataOperations dp = new DataOperations();
            ...
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                dsTemperatura.Pellet_2.Clear();
                da.Fill(dsTemperatura.Pellet_2);
                cn.Close();
        ...
        private void cmdPrint_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@id_turno_horario", row.id_turno_horario);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                dsTemperatura2.Pellet_2.Clear();
                da.Fill(dsTemperatura2.Pellet_2);
                cn.Close();
                ...
                rptTemperaturasPellet2 report = new rptTemperaturasPellet2("Pellet 2") { DataSource = dsTemperatura2, DataMember = "Pellet_2", ShowPrintMarginsWarning = false };
