...
{
    public partial class xfrmTemperaturaMolinosTilapia : DevExpress.XtraEditors.XtraForm
    {
        public xfrmTemperaturaMolinosTilapia()
        {
            InitializeComponent();
            load_orden_activas();
        }
        ...
        {
            string query = @"dbo.sp_get_turnos_registro_temperaturas_Molinos_Tilapia";
        ...
        private void gridView1_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            string query = @"dbo.sp_get_temperatura_molinos_tilapia_log_v2";
            DataOperations dp = new DataOperations();
            ...
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                dsTemperatura.Molinos_Tilapia.Clear();
                da.Fill(dsTemperatura.Molinos_Tilapia);
                cn.Close();
        ...
        private void cmdPrint_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@id_turno_horario", row.id_turno_horario);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                dsTemperatura2.Molinos_Tilapia.Clear();
                da.Fill(dsTemperatura2.Molinos_Tilapia);
                cn.Close();
                ...
                rptTemperaturasMolinosTilapia report = new rptTemperaturasMolinosTilapia("Molinos Tilapia") { DataSource = dsTemperatura2, DataMember = "Molinos_Tilapia", ShowPrintMarginsWarning = false };
