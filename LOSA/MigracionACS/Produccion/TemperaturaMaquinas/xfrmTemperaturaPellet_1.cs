...
{
    public partial class xfrmTemperaturaPellet_1 : DevExpress.XtraEditors.XtraForm
    {
        public xfrmTemperaturaPellet_1()
        {
            InitializeComponent();
            load_orden_activas();
        }
        ...
        {
            string query = @"dbo.sp_get_turnos_registro_temperaturas_Pellet_1";
        ...
        private void gridView1_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            string query = @"dbo.sp_get_temperatura_pellet_1_log_V3";
            DataOperations dp = new DataOperations();
            ...
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                dsTemperatura.Pellet_1.Clear();
                da.Fill(dsTemperatura.Pellet_1);
                cn.Close();
        ...
        private void cmdPrint_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@id_turno_horario", row.id_turno_horario);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                dsTemperatura2.Pellet_1.Clear();
                da.Fill(dsTemperatura2.Pellet_1);
                ...
                cn.Close();
                rptTemperaturasPellet1 report = new rptTemperaturasPellet1("Pellet 1") { DataSource = dsTemperatura2, ShowPrintMarginsWarning = false };
