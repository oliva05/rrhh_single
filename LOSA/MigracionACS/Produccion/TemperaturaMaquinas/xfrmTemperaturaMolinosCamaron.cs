...
{
    public partial class xfrmTemperaturaMolinosCamaron : DevExpress.XtraEditors.XtraForm
    {
        public xfrmTemperaturaMolinosCamaron()
        {
            InitializeComponent();
            load_orden_activas();
        }
        ...
        {
            string query = @"dbo.sp_get_turnos_registro_temperaturas_Molinos_Camaron";
        ...
        private void gridView1_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            string query = @"dbo.sp_get_temperatura_molinos_camaron_log_v2";
            DataOperations dp = new DataOperations();
            ...
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                dsTemperatura.Molinos_Camaron.Clear();
                da.Fill(dsTemperatura.Molinos_Camaron);
                cn.Close();
        ...
        private void cmdPrint_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@id_turno_horario", row.id_turno_horario);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                dsTemperatura2.Molinos_Camaron.Clear();
                da.Fill(dsTemperatura2.Molinos_Camaron);
                ...
                cn.Close();
                rptTemperaturasMolinosCamaron report = new rptTemperaturasMolinosCamaron("Molinos Camaron") { DataSource = dsTemperatura2, DataMember = "Molinos_Camaron", ShowPrintMarginsWarning = false };
