...
{
    public partial class frmNuevoCriterio : DevExpress.XtraEditors.XtraForm
    {
        int type = 0;
        int id = 0;
        DataOperations dp = new DataOperations();
        public frmNuevoCriterio()
        {
            InitializeComponent();
            type = 1;
        ...
        public frmNuevoCriterio(int Pid, string Pcriterio)
        {
            InitializeComponent();
            id = Pid;
            type = 2;
        ...
        private void btnnuevo_Click(object sender, EventArgs e)
        {
            ...
            if (type == 1)
            {         // nuevo
                string query = "sp_insert_olor_criterio";
            ...
            {
                string query = "sp_update_olor_criterio";
                SqlConnection cn = new SqlConnection(dp.ConnectionStringLOSA);
                try
                {
                    cn.Open();
