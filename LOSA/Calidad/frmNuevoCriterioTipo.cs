...
{
    public partial class frmNuevoCriterioTipo : DevExpress.XtraEditors.XtraForm
    {

        int type = 0;
        int id = 0;
        DataOperations dp = new DataOperations();
        public frmNuevoCriterioTipo()
        {
            InitializeComponent();
            type = 1;
        ...
        public frmNuevoCriterioTipo(int Pid, string Pcriterio)
        {
            InitializeComponent();
            id = Pid;
            type = 2;
        ...
        private void btnnuevo_Click(object sender, EventArgs e)
        {
            ...
            if (type == 1)
            {         // nuevo
                string query = "sp_insert_tipo_criterio";
            ...
            {
                string query = "sp_update_tipo_criterio";
                SqlConnection cn = new SqlConnection(dp.ConnectionStringLOSA);
                try
                {
                    cn.Open();
