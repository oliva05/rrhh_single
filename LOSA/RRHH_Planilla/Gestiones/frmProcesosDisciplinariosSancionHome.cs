...
{
    public partial class frmProcesosDisciplinariosSancionHome : DevExpress.XtraEditors.XtraForm
    {
        UserLogin usuarioLog;
        public frmProcesosDisciplinariosSancionHome(UserLogin user)
        {
            InitializeComponent();
            usuarioLog = user;
            CargarDatos();
        ...
        public void CargarDatos()
        {
            try
            {
                ...
                dsMantenimientoPlanilla.res_bank.Clear();
                ...
                using (SqlDataAdapter da = new SqlDataAdapter("dbo.uspLoadBank", cnx))
                {
                    ...
                    da.Fill(dsMantenimientoPlanilla.res_bank);
                    cnx.Close();
                }
            }
            catch (Exception ex)
