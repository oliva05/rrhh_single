...
{
    public partial class frmOrdenesCompraMainV2 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmOrdenesCompraMainV2(TipoOperacion ptipo, int pIdOrdenCompraH)
        {
            InitializeComponent();
            CargarResoluciones();
            LoadTipoOrden();
        ...
        public frmOrdenesCompraMainV2(UserLogin pUserLog, TipoOperacion ptipo)
        {
            InitializeComponent();
            CargarResoluciones();
            LoadTipoOrden();
                ...
                switch (e.Column.FieldName)
                {
                    case "cantidad":
                        ...
                        switch (row.indicador_impuesto)
                        {
                            ...
                            case "ISVE":
                                row.isv = (row.cantidad * row.precio_por_unidad) * Convert.ToDecimal(0.18);
                                break;
        ...
        private void frmOrdenesCompraMainV2_Load(object sender, EventArgs e)
        {
        ...
        private void reposSelectCapitulo_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            var gridview = (GridView)grDetalle.FocusedView;
            var row = (dsCompras.oc_detalle_exoneradaRow)gridview.GetFocusedDataRow();
            ...
            {
                CajaDialogo.Error("La Orden no esta Marcada como OC Exonerada!");
                return;
            }

        }

        private void reposSelectPartArancelaria_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            var gridview = (GridView)grDetalle.FocusedView;
            var row = (dsCompras.oc_detalle_exoneradaRow)gridview.GetFocusedDataRow();
