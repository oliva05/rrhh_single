...
{
    public partial class frmCambiarMaterialTanqueList : DevExpress.XtraEditors.XtraForm
    {
        ...
        DataOperations dp;
        public frmCambiarMaterialTanqueList(UserLogin pUser, int pIdEstado, int pIdPayslipRun)
        {
            InitializeComponent();
